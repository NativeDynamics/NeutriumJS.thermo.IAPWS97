...
var NeutriumJS = (function (NeutriumJS) {
	...
	// Exposed for testing
	NS.b23_P_T = b23_P_T;
	NS.r4_T_Psat = r4_T_Psat;
	NS.r4_P_Tsat = r4_P_Tsat;
	NS.b23_T_P = b23_T_P;
	NS.b3ab_P_T = b3ab_P_T;
	NS.b3cd_P_T = b3cd_P_T;
	NS.b3ef_P_T = b3ef_P_T;
	NS.b3gh_P_T = b3gh_P_T;
	NS.b3ij_P_T = b3ij_P_T;
	NS.b3jk_P_T = b3jk_P_T;
	NS.b3mn_P_T = b3mn_P_T;
	NS.b3op_P_T = b3op_P_T;
	NS.b3qu_P_T = b3qu_P_T;
	NS.b3rx_P_T = b3rx_P_T;
	NS.b3uv_P_T = b3uv_P_T;
	NS.b3wx_P_T = b3wx_P_T;
	NS.aux_Viscosity = aux_Viscosity;
	NS.aux_Thermal_Conductivity = aux_Thermal_Conductivity;
	NS.aux_Surface_Tension = aux_Surface_Tension;
	NS.aux_Dielectric_Constant = aux_Dielectric_Constant;
	NS.aux_Ionization_Constant = aux_Ionization_Constant;
	return NeutriumJS;
	...
	function generateResult(r)
	{
		...
		result.w = r.w;
		// Viscosity cP,
		result.mu = aux_Viscosity(r.T, result.rho)/1000;
		// Thermal Conductivity W/m.K
		result.k = aux_Thermal_Conductivity(r.T, result.rho)/1000;
		// Surface Tension mN/m
		result.sig = aux_Surface_Tension(r.T);
		// Dielectric constant
		result.epsilon = aux_Dielectric_Constant(r.T, result.rho);
		// Ionisation constant
		result.ic = aux_Ionization_Constant(r.T, result.rho);
		return result;
	}
